...
sixHopID_Num_dict = defaultdict(lambda: 0)
...
path_sevenHop_collaborator = r"E:\XF\图灵数补充实验\处理数据集\修改-仅保留前2作-每人最多查5篇论文\7hop_collabor_IDs.txt"

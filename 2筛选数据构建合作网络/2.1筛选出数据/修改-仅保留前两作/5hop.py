...
one_hop_collaborator_ids_FULL = set()  # 1 hop id
two_hop_collaborator_ids_FULL = set()  # 2 hop id
three_hop_collaborator_ids_FULL = set()  # 3 hop id
four_hop_collaborator_ids_FULL = set()  # 4 hop id
...
with open(path_fiveHop_collaborator, 'w', encoding='utf-8') as f:
    ...
    for id in five_hop_collaborator_ids:
        if id not in four_hop_collaborator_ids_FULL and\

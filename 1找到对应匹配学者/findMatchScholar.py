...
paper_path = r"E:\XF\图灵数补充实验\图灵数据集\原始数据\处理前数据\1.论文列表.csv"
author_path = r"E:\XF\图灵数补充实验\图灵数据集\原始数据\处理前数据\2.学者列表.csv"
...
tolCnt = 0
multiCnt = 0
path_out = r"E:\XF\图灵数补充实验\处理数据集\Matched_AuthorName_Org_IDs.txt"
